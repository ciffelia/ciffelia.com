...
type ContentfulWork = ContentfulReference & ContentfulEntry & Node & {
  readonly contentful_id: Scalars['String'];
  readonly id: Scalars['ID'];
  readonly node_locale: Scalars['String'];
  readonly title: Maybe<Scalars['String']>;
  ...
  readonly worklist: Maybe<ReadonlyArray<Maybe<ContentfulWorkList>>>;
  readonly spaceId: Maybe<Scalars['String']>;
  readonly createdAt: Maybe<Scalars['Date']>;
  readonly updatedAt: Maybe<Scalars['Date']>;
...
type ContentfulWorkList = ContentfulReference & ContentfulEntry & Node & {
  readonly contentful_id: Scalars['String'];
  readonly id: Scalars['ID'];
  readonly node_locale: Scalars['String'];
  readonly name: Maybe<Scalars['String']>;
  readonly entries: Maybe<ReadonlyArray<Maybe<ContentfulWork>>>;
  readonly spaceId: Maybe<Scalars['String']>;
  readonly createdAt: Maybe<Scalars['Date']>;
  readonly updatedAt: Maybe<Scalars['Date']>;
  readonly sys: Maybe<ContentfulWorkListSys>;
  readonly parent: Maybe<Node>;
  readonly children: ReadonlyArray<Node>;
  readonly internal: Internal;
};
...
type ContentfulWorkList_createdAtArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type ContentfulWorkList_updatedAtArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type ContentfulWorkListSys = {
  readonly type: Maybe<Scalars['String']>;
  readonly revision: Maybe<Scalars['Int']>;
  readonly contentType: Maybe<ContentfulWorkListSysContentType>;
};

type ContentfulWorkListSysContentType = {
  readonly sys: Maybe<ContentfulWorkListSysContentTypeSys>;
};

type ContentfulWorkListSysContentTypeSys = {
  readonly type: Maybe<Scalars['String']>;
  readonly linkType: Maybe<Scalars['String']>;
  readonly id: Maybe<Scalars['String']>;
};
...
type Query = {
  ...
  readonly contentfulWorkList: Maybe<ContentfulWorkList>;
  readonly allContentfulWorkList: ContentfulWorkListConnection;
...
type Query_contentfulWorkArgs = {
  ...
  worklist: Maybe<ContentfulWorkListFilterListInput>;
  spaceId: Maybe<StringQueryOperatorInput>;
  createdAt: Maybe<DateQueryOperatorInput>;
  updatedAt: Maybe<DateQueryOperatorInput>;
...
type Query_contentfulWorkListArgs = {
  contentful_id: Maybe<StringQueryOperatorInput>;
  id: Maybe<StringQueryOperatorInput>;
  node_locale: Maybe<StringQueryOperatorInput>;
  name: Maybe<StringQueryOperatorInput>;
  entries: Maybe<ContentfulWorkFilterListInput>;
  spaceId: Maybe<StringQueryOperatorInput>;
  createdAt: Maybe<DateQueryOperatorInput>;
  updatedAt: Maybe<DateQueryOperatorInput>;
  sys: Maybe<ContentfulWorkListSysFilterInput>;
  parent: Maybe<NodeFilterInput>;
  children: Maybe<NodeFilterListInput>;
  internal: Maybe<InternalFilterInput>;
};
...
type Query_allContentfulWorkListArgs = {
  filter: Maybe<ContentfulWorkListFilterInput>;
  sort: Maybe<ContentfulWorkListSortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};
...
type ContentfulWorkListFilterListInput = {
  readonly elemMatch: Maybe<ContentfulWorkListFilterInput>;
};

type ContentfulWorkListFilterInput = {
  readonly contentful_id: Maybe<StringQueryOperatorInput>;
  readonly id: Maybe<StringQueryOperatorInput>;
  readonly node_locale: Maybe<StringQueryOperatorInput>;
  readonly name: Maybe<StringQueryOperatorInput>;
  readonly entries: Maybe<ContentfulWorkFilterListInput>;
  readonly spaceId: Maybe<StringQueryOperatorInput>;
  readonly createdAt: Maybe<DateQueryOperatorInput>;
  readonly updatedAt: Maybe<DateQueryOperatorInput>;
  readonly sys: Maybe<ContentfulWorkListSysFilterInput>;
  readonly parent: Maybe<NodeFilterInput>;
  readonly children: Maybe<NodeFilterListInput>;
  readonly internal: Maybe<InternalFilterInput>;
};

type ContentfulWorkFilterListInput = {
  readonly elemMatch: Maybe<ContentfulWorkFilterInput>;
};
...
type ContentfulWorkFilterInput = {
  ...
  readonly worklist: Maybe<ContentfulWorkListFilterListInput>;
  readonly spaceId: Maybe<StringQueryOperatorInput>;
  readonly createdAt: Maybe<DateQueryOperatorInput>;
  readonly updatedAt: Maybe<DateQueryOperatorInput>;
  readonly sys: Maybe<ContentfulWorkSysFilterInput>;
  readonly parent: Maybe<NodeFilterInput>;
  readonly children: Maybe<NodeFilterListInput>;
  readonly internal: Maybe<InternalFilterInput>;
};
...
type ContentfulWorkSysFilterInput = {
  readonly type: Maybe<StringQueryOperatorInput>;
  readonly revision: Maybe<IntQueryOperatorInput>;
  readonly contentType: Maybe<ContentfulWorkSysContentTypeFilterInput>;
};

type ContentfulWorkSysContentTypeFilterInput = {
  readonly sys: Maybe<ContentfulWorkSysContentTypeSysFilterInput>;
};
...
type ContentfulWorkListSysFilterInput = {
  readonly type: Maybe<StringQueryOperatorInput>;
  readonly revision: Maybe<IntQueryOperatorInput>;
  readonly contentType: Maybe<ContentfulWorkListSysContentTypeFilterInput>;
};

type ContentfulWorkListSysContentTypeFilterInput = {
  readonly sys: Maybe<ContentfulWorkListSysContentTypeSysFilterInput>;
};

type ContentfulWorkListSysContentTypeSysFilterInput = {
  readonly type: Maybe<StringQueryOperatorInput>;
  readonly linkType: Maybe<StringQueryOperatorInput>;
  readonly id: Maybe<StringQueryOperatorInput>;
};
...
type ContentfulWorkFieldsEnum =
  ...
  | 'image.internal.type'
  | 'worklist'
  | 'worklist.contentful_id'
  | 'worklist.id'
  | 'worklist.node_locale'
  | 'worklist.name'
  | 'worklist.entries'
  | 'worklist.entries.contentful_id'
  | 'worklist.entries.id'
  | 'worklist.entries.node_locale'
  | 'worklist.entries.title'
  | 'worklist.entries.year'
  | 'worklist.entries.tags'
  | 'worklist.entries.url'
  | 'worklist.entries.image.contentful_id'
  | 'worklist.entries.image.id'
  | 'worklist.entries.image.spaceId'
  | 'worklist.entries.image.createdAt'
  | 'worklist.entries.image.updatedAt'
  | 'worklist.entries.image.title'
  | 'worklist.entries.image.description'
  | 'worklist.entries.image.node_locale'
  | 'worklist.entries.image.gatsbyImageData'
  | 'worklist.entries.image.children'
  | 'worklist.entries.worklist'
  | 'worklist.entries.worklist.contentful_id'
  | 'worklist.entries.worklist.id'
  | 'worklist.entries.worklist.node_locale'
  | 'worklist.entries.worklist.name'
  | 'worklist.entries.worklist.entries'
  | 'worklist.entries.worklist.spaceId'
  | 'worklist.entries.worklist.createdAt'
  | 'worklist.entries.worklist.updatedAt'
  | 'worklist.entries.worklist.children'
  | 'worklist.entries.spaceId'
  | 'worklist.entries.createdAt'
  | 'worklist.entries.updatedAt'
  | 'worklist.entries.sys.type'
  | 'worklist.entries.sys.revision'
  | 'worklist.entries.parent.id'
  | 'worklist.entries.parent.children'
  | 'worklist.entries.children'
  | 'worklist.entries.children.id'
  | 'worklist.entries.children.children'
  | 'worklist.entries.internal.content'
  | 'worklist.entries.internal.contentDigest'
  | 'worklist.entries.internal.description'
  | 'worklist.entries.internal.fieldOwners'
  | 'worklist.entries.internal.ignoreType'
  | 'worklist.entries.internal.mediaType'
  | 'worklist.entries.internal.owner'
  | 'worklist.entries.internal.type'
  | 'worklist.spaceId'
  | 'worklist.createdAt'
  | 'worklist.updatedAt'
  | 'worklist.sys.type'
  | 'worklist.sys.revision'
  | 'worklist.parent.id'
  | 'worklist.parent.parent.id'
  | 'worklist.parent.parent.children'
  | 'worklist.parent.children'
  | 'worklist.parent.children.id'
  | 'worklist.parent.children.children'
  | 'worklist.parent.internal.content'
  | 'worklist.parent.internal.contentDigest'
  | 'worklist.parent.internal.description'
  | 'worklist.parent.internal.fieldOwners'
  | 'worklist.parent.internal.ignoreType'
  | 'worklist.parent.internal.mediaType'
  | 'worklist.parent.internal.owner'
  | 'worklist.parent.internal.type'
  | 'worklist.children'
  | 'worklist.children.id'
  | 'worklist.children.parent.id'
  | 'worklist.children.parent.children'
  | 'worklist.children.children'
  | 'worklist.children.children.id'
  | 'worklist.children.children.children'
  | 'worklist.children.internal.content'
  | 'worklist.children.internal.contentDigest'
  | 'worklist.children.internal.description'
  | 'worklist.children.internal.fieldOwners'
  | 'worklist.children.internal.ignoreType'
  | 'worklist.children.internal.mediaType'
  | 'worklist.children.internal.owner'
  | 'worklist.children.internal.type'
  | 'worklist.internal.content'
  | 'worklist.internal.contentDigest'
  | 'worklist.internal.description'
  | 'worklist.internal.fieldOwners'
  | 'worklist.internal.ignoreType'
  | 'worklist.internal.mediaType'
  | 'worklist.internal.owner'
  | 'worklist.internal.type'
  | 'spaceId'
  | 'createdAt'
  | 'updatedAt'
  | 'sys.type'
...
type ContentfulWorkSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<ContentfulWorkFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};

type ContentfulWorkListConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<ContentfulWorkListEdge>;
  readonly nodes: ReadonlyArray<ContentfulWorkList>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<ContentfulWorkListGroupConnection>;
};


type ContentfulWorkListConnection_distinctArgs = {
  field: ContentfulWorkListFieldsEnum;
};


type ContentfulWorkListConnection_maxArgs = {
  field: ContentfulWorkListFieldsEnum;
};


type ContentfulWorkListConnection_minArgs = {
  field: ContentfulWorkListFieldsEnum;
};


type ContentfulWorkListConnection_sumArgs = {
  field: ContentfulWorkListFieldsEnum;
};


type ContentfulWorkListConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: ContentfulWorkListFieldsEnum;
};

type ContentfulWorkListEdge = {
  readonly next: Maybe<ContentfulWorkList>;
  readonly node: ContentfulWorkList;
  readonly previous: Maybe<ContentfulWorkList>;
};

type ContentfulWorkListFieldsEnum =
  | 'contentful_id'
  | 'id'
  | 'node_locale'
  | 'name'
  | 'entries'
  | 'entries.contentful_id'
  | 'entries.id'
  | 'entries.node_locale'
  | 'entries.title'
  | 'entries.year'
  | 'entries.tags'
  | 'entries.url'
  | 'entries.image.contentful_id'
  | 'entries.image.id'
  | 'entries.image.spaceId'
  | 'entries.image.createdAt'
  | 'entries.image.updatedAt'
  | 'entries.image.file.url'
  | 'entries.image.file.fileName'
  | 'entries.image.file.contentType'
  | 'entries.image.title'
  | 'entries.image.description'
  | 'entries.image.node_locale'
  | 'entries.image.sys.type'
  | 'entries.image.sys.revision'
  | 'entries.image.localFile.sourceInstanceName'
  | 'entries.image.localFile.absolutePath'
  | 'entries.image.localFile.relativePath'
  | 'entries.image.localFile.extension'
  | 'entries.image.localFile.size'
  | 'entries.image.localFile.prettySize'
  | 'entries.image.localFile.modifiedTime'
  | 'entries.image.localFile.accessTime'
  | 'entries.image.localFile.changeTime'
  | 'entries.image.localFile.birthTime'
  | 'entries.image.localFile.root'
  | 'entries.image.localFile.dir'
  | 'entries.image.localFile.base'
  | 'entries.image.localFile.ext'
  | 'entries.image.localFile.name'
  | 'entries.image.localFile.relativeDirectory'
  | 'entries.image.localFile.dev'
  | 'entries.image.localFile.mode'
  | 'entries.image.localFile.nlink'
  | 'entries.image.localFile.uid'
  | 'entries.image.localFile.gid'
  | 'entries.image.localFile.rdev'
  | 'entries.image.localFile.ino'
  | 'entries.image.localFile.atimeMs'
  | 'entries.image.localFile.mtimeMs'
  | 'entries.image.localFile.ctimeMs'
  | 'entries.image.localFile.atime'
  | 'entries.image.localFile.mtime'
  | 'entries.image.localFile.ctime'
  | 'entries.image.localFile.birthtime'
  | 'entries.image.localFile.birthtimeMs'
  | 'entries.image.localFile.blksize'
  | 'entries.image.localFile.blocks'
  | 'entries.image.localFile.url'
  | 'entries.image.localFile.childrenImageSharp'
  | 'entries.image.localFile.id'
  | 'entries.image.localFile.children'
  | 'entries.image.fixed.base64'
  | 'entries.image.fixed.tracedSVG'
  | 'entries.image.fixed.aspectRatio'
  | 'entries.image.fixed.width'
  | 'entries.image.fixed.height'
  | 'entries.image.fixed.src'
  | 'entries.image.fixed.srcSet'
  | 'entries.image.fixed.srcWebp'
  | 'entries.image.fixed.srcSetWebp'
  | 'entries.image.fluid.base64'
  | 'entries.image.fluid.tracedSVG'
  | 'entries.image.fluid.aspectRatio'
  | 'entries.image.fluid.src'
  | 'entries.image.fluid.srcSet'
  | 'entries.image.fluid.srcWebp'
  | 'entries.image.fluid.srcSetWebp'
  | 'entries.image.fluid.sizes'
  | 'entries.image.gatsbyImageData'
  | 'entries.image.resize.base64'
  | 'entries.image.resize.tracedSVG'
  | 'entries.image.resize.src'
  | 'entries.image.resize.width'
  | 'entries.image.resize.height'
  | 'entries.image.resize.aspectRatio'
  | 'entries.image.parent.id'
  | 'entries.image.parent.children'
  | 'entries.image.children'
  | 'entries.image.children.id'
  | 'entries.image.children.children'
  | 'entries.image.internal.content'
  | 'entries.image.internal.contentDigest'
  | 'entries.image.internal.description'
  | 'entries.image.internal.fieldOwners'
  | 'entries.image.internal.ignoreType'
  | 'entries.image.internal.mediaType'
  | 'entries.image.internal.owner'
  | 'entries.image.internal.type'
  | 'entries.worklist'
  | 'entries.worklist.contentful_id'
  | 'entries.worklist.id'
  | 'entries.worklist.node_locale'
  | 'entries.worklist.name'
  | 'entries.worklist.entries'
  | 'entries.worklist.entries.contentful_id'
  | 'entries.worklist.entries.id'
  | 'entries.worklist.entries.node_locale'
  | 'entries.worklist.entries.title'
  | 'entries.worklist.entries.year'
  | 'entries.worklist.entries.tags'
  | 'entries.worklist.entries.url'
  | 'entries.worklist.entries.worklist'
  | 'entries.worklist.entries.spaceId'
  | 'entries.worklist.entries.createdAt'
  | 'entries.worklist.entries.updatedAt'
  | 'entries.worklist.entries.children'
  | 'entries.worklist.spaceId'
  | 'entries.worklist.createdAt'
  | 'entries.worklist.updatedAt'
  | 'entries.worklist.sys.type'
  | 'entries.worklist.sys.revision'
  | 'entries.worklist.parent.id'
  | 'entries.worklist.parent.children'
  | 'entries.worklist.children'
  | 'entries.worklist.children.id'
  | 'entries.worklist.children.children'
  | 'entries.worklist.internal.content'
  | 'entries.worklist.internal.contentDigest'
  | 'entries.worklist.internal.description'
  | 'entries.worklist.internal.fieldOwners'
  | 'entries.worklist.internal.ignoreType'
  | 'entries.worklist.internal.mediaType'
  | 'entries.worklist.internal.owner'
  | 'entries.worklist.internal.type'
  | 'entries.spaceId'
  | 'entries.createdAt'
  | 'entries.updatedAt'
  | 'entries.sys.type'
  | 'entries.sys.revision'
  | 'entries.parent.id'
  | 'entries.parent.parent.id'
  | 'entries.parent.parent.children'
  | 'entries.parent.children'
  | 'entries.parent.children.id'
  | 'entries.parent.children.children'
  | 'entries.parent.internal.content'
  | 'entries.parent.internal.contentDigest'
  | 'entries.parent.internal.description'
  | 'entries.parent.internal.fieldOwners'
  | 'entries.parent.internal.ignoreType'
  | 'entries.parent.internal.mediaType'
  | 'entries.parent.internal.owner'
  | 'entries.parent.internal.type'
  | 'entries.children'
  | 'entries.children.id'
  | 'entries.children.parent.id'
  | 'entries.children.parent.children'
  | 'entries.children.children'
  | 'entries.children.children.id'
  | 'entries.children.children.children'
  | 'entries.children.internal.content'
  | 'entries.children.internal.contentDigest'
  | 'entries.children.internal.description'
  | 'entries.children.internal.fieldOwners'
  | 'entries.children.internal.ignoreType'
  | 'entries.children.internal.mediaType'
  | 'entries.children.internal.owner'
  | 'entries.children.internal.type'
  | 'entries.internal.content'
  | 'entries.internal.contentDigest'
  | 'entries.internal.description'
  | 'entries.internal.fieldOwners'
  | 'entries.internal.ignoreType'
  | 'entries.internal.mediaType'
  | 'entries.internal.owner'
  | 'entries.internal.type'
  | 'spaceId'
  | 'createdAt'
  | 'updatedAt'
  | 'sys.type'
...
type ContentfulWorkListGroupConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<ContentfulWorkListEdge>;
  readonly nodes: ReadonlyArray<ContentfulWorkList>;
  readonly pageInfo: PageInfo;
...
type ContentfulWorkListGroupConnection_distinctArgs = {
  field: ContentfulWorkListFieldsEnum;
};


type ContentfulWorkListGroupConnection_maxArgs = {
  field: ContentfulWorkListFieldsEnum;
};


type ContentfulWorkListGroupConnection_minArgs = {
  field: ContentfulWorkListFieldsEnum;
};


type ContentfulWorkListGroupConnection_sumArgs = {
  field: ContentfulWorkListFieldsEnum;
};


type ContentfulWorkListGroupConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: ContentfulWorkListFieldsEnum;
};

type ContentfulWorkListSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<ContentfulWorkListFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};
...
type WorksQuery = { readonly contentfulWorkList: Maybe<{ readonly entries: Maybe<ReadonlyArray<Maybe<(
      Pick<ContentfulWork, 'id' | 'title' | 'year' | 'tags' | 'url'>
      & { readonly image: Maybe<{ readonly localFile: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> }> }
    )>>> }> };
